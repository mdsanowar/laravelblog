				...
				<div class="body">
					...
					<div class="tab-content">
							...
							<div class="row clearfix">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="card">
										...
										<div class="body">
											<form action="{{ route('author.update.profile') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
												@csrf
												@method('PUT')
						...
						<div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
							<form action="{{ route('author.update.password') }}" class="form-horizontal" method="POST">
								@csrf
								@method('PUT')
