                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($post->is_approved == false)
                                        <button type="button" onclick="approvePost({{$post->id}})" class="btn btn-success">
                                    ...
                                    @endif
                                        ...
                                        <button type="button" onclick="deleteTag({{$post->id}})" class="btn btn-danger btn-sm waves-effect">
